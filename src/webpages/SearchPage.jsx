      ...
      <>
        ...
        {results ? results.map((result) => {
          return <div className='d-flex bd-highlight mb-3'>
            ...
            <img style={{borderRadius: "50px"}}height="200px" width="200px" src={result.backgroundImage ? result.backgroundImage : "http://placehold.it/200x100"}></img>
            </a>
            </div>
            <div className="p-2 bd-highlight">
              <a href={typeof result.quizzes !== 'undefined' ? "/platform/" + result.id : "/quiz/" + result.id}>
            ...
            <p style={{color: 'hotpink'}}>{result.timestamp ? "Available since: " + new Date(result.timestamp).getDate() + "/" 
            : ""}
            {new Date(result.timestamp).getMonth() + 1}
