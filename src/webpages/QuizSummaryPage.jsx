        ...
        <div className='mask'>
          ...
          <MDBCard style={{ backgroundColor: 'rgba(0, 0, 0, 0.8)', maxWidth: '33rem' }}>
            ...
            <MDBBtn rounded style={{marginLeft: "1rem",color: "white", backgroundColor: "#5321d0"}}>Leader Board</MDBBtn>
                ...
                <p className='d-flex justify-content-center'>Time Limit: {quiz.timeLimitSeconds < 60 ? quiz.timeLimitSeconds + " seconds ": ((quiz.timeLimitSeconds)/60) + " minutes " + ((quiz.timeLimitSeconds) % 60) + " seconds"}</p>
