...
const QuizEdit = () => {
    //TODO: make sure to delete answers that doesn't have any input
    ...
    function addAnswer(){
        ...
        tempQuestion.answers = [...tempQuestion.answers, answer];
    ...
    function changeQuestionImage(e){
        ...
        reader.onloadend = function() {
            var tempQuestion = question;
            tempQuestion.imageUrl = reader.result;
            setQuestion(tempQuestion);
    ...
    function changeQuestionText(e){
        var tempQuestion = question;
        tempQuestion.questionText = e.target.value;
        setQuestion(tempQuestion);
    ...
    function updateCorrectAnswer(idx){
        var tempQuestion = question;
        tempQuestion.answers[idx].correctAnswer = !tempQuestion.answers[idx].correctAnswer;
        setQuestion(tempQuestion);
        console.log(question.answers[idx].correctAnswer);
    }

    function updateAnswer(idx, e){
        var tempQuestion = question;
        tempQuestion.answers[idx].answerText = e.target.value;
        setQuestion(tempQuestion);
    }
                        ...
                        quiz.questions.map((question, indx) => 
                            <MDBCardBody
                                ...
                                onClick={() => {
                                    ...
                                    var tempQuestion = Object.assign({}, question);
                                    setQuestion(tempQuestion);
                                    setQuestionNum(indx);
                                    console.log(indx, question)
                                }}
                            >
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body text-center pb-0">
        ...
        <img style={{cursor: 'pointer'}} src={questionImageButton()}></img>
        </label>
          ...
          <div className="answers">
                  ...
                  <div>
                      <span><input type="checkbox" onClick={()=>{updateCorrectAnswer(idx)}} defaultChecked={question.answers[idx].correctAnswer}></input></span>
      ...
      <div class="row col-4 offset-4 mb-2">
        <button type="button" 
        onClick={()=>addAnswer() } class="btn btn-primary" style={{backgroundColor: 'purple'}}>
          Add Answer
        </button>
        </div>
